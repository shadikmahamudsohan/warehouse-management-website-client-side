...
const UserReview = ({ dark }) => {
    const reviews = [
        ...
        { id: 2, img: 'https://i.ibb.co/fNhHPBS/user2.jpg', name: 'Ms. Rokea', description: 'Medicine is a important Item. It has to be managed properly. I think this website does the right thing for managing there products. It keeps count of its products.' },
        ...
        { id: 5, img: 'https://i.ibb.co/2NZx4Rg/user5.jpg', name: 'Dr. Kamal', description: 'It is so hard to keep management of my medicine. So it is hard to by many kinds of medicine at a time. It website helped me a lot.' },
    ]
    ...
    return (
        <section className='container my-5'>
            <h1 className='mb-5'>See what Other Says _________________________</h1>
            <Row>
                <Slider {...settings}>
                    {
